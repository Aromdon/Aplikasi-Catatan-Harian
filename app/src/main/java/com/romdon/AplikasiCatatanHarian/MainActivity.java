...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MainActivity.this, InsertAndViewActitvity.class);
    ...
    void mengambilListFilePadaFolder(){
        ...
        if (directory.exists()){
            ...
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd MMM YYYY HH:dd:ss");
            ...
            SimpleAdapter simpleAdapter = new SimpleAdapter(this, itemDataList, android.R.layout.simple_list_item_2,
                    new String[]{"name", "data"}, new int[]{android.R.id.text1, android.R.id.text2});
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item){
        switch (item.getItemId()){
            case R.id.action_tambah:
                Intent i = new Intent(this, InsertAndViewActitvity.class);
                startActivity(i);
                break;
        }
